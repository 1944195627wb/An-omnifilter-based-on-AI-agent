...
appid = "a649217d"    #填写控制台中获取的 APPID 信息
api_secret = "YjA1YjhkNDY1MWM3NTE4MzgwMjdhMmVk"   #填写控制台中获取的 APISecret 信息
api_key ="f4c90906cc7b73f16c88f3e15d0013c6"    #填写控制台中获取的 APIKey 信息

imagedata1 = open("image_understand/test/1.jpg",'rb').read()




imageunderstanding_url = "wss://spark-api.cn-huabei-1.xf-yun.com/v2.1/image"#云端环境的服务地址
text =[{"role": "user", "content": str(base64.b64encode(imagedata1), 'utf-8'), "content_type":"image"}]
